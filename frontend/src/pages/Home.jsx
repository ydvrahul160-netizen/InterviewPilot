        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center flex flex-col justify-center items-center mb-20">
            <motion.h1
              ...
              className="text-2xl md:text-4xl font-semibold leading-tight max-w-4xl mx-auto"
            >
            ...
            >
              Role-base mock interview with smart follow-ups, adaptive
            ...
            {[
              {
                ...
                desc: "AI adjusts difficulty based on detected job role.",
              },
              {
                icon: <BsMic size={24} />,
                step: "STEP 2",
                title: "Smart Voice Interview",
                desc: "Dynamic foll0w-up questions based on your answer.",
              },
              {
              ...
              return (
                <motion.div
                  ...
                  className={`
              relative bg-white rounded-3xl border-2 border-blue-100 hover:border-blue-500 p-7 w-80 max-w-[90%] shadow-md hover:shadow-2xl
              ...
              `}
                >
                  <div
                    className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-blue-500
               text-blue-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg"
                  >
                    {item.icon}
                  </div>
